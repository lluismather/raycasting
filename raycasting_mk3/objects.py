...
class objects:
    ...
    def ray_source(self, coords, lim_a, lim_b, centre):
        x, y = coords
        x1, x2 = x - 1, x + 1
        y1, y2 = y - 1, y + 1
        ...
        field_of_view = self.raycast.cast_rays(x, y, self.lines, lim_a, lim_b, self.WIDTH, centre)
        render.renderer(field_of_view, self.CANVAS, self.WIDTH, self.HEIGHT)
